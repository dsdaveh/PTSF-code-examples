...
Although not called for in the textbook, we can also use a `seasonal plot` to help identify months with peak ridership and confirm a general upward trend in the later years contained in the dataset
