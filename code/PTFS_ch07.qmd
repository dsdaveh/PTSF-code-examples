...
Figure 7.7 and 7.8 use data from https://www.kaggle.com/competitions/walmart-recruiting-store-sales-forecasting/data, which is not avaialable on the textbook website. The figures are not reproduced here as downloading the dataset would violate the terms of use on Kaggle.
